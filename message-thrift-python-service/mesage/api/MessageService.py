...
class Client(Iface):
    ...
    def sendEmailMessae(self, email, message):
        ...
        Parameters:
         ...
         - message
        """
        self.send_sendEmailMessae(email, message)
        return self.recv_sendEmailMessae()

    def send_sendEmailMessae(self, email, message):
        self._oprot.writeMessageBegin('sendEmailMessae', TMessageType.CALL, self._seqid)
        args = sendEmailMessae_args()
        args.email = email
        args.message = message
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
    ...
    def recv_sendEmailMessae(self):
        ...
        if mtype == TMessageType.EXCEPTION:
            ...
            iprot.readMessageEnd()
            raise x
        result = sendEmailMessae_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "sendEmailMessae failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["sendEmailMessae"] = Processor.process_sendEmailMessae
    ...
    def process_sendEmailMessae(self, seqid, iprot, oprot):
        args = sendEmailMessae_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = sendEmailMessae_result()
        try:
            result.success = self._handler.sendEmailMessae(args.email, args.message)
            msg_type = TMessageType.REPLY
        except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
            raise
        except Exception as ex:
            ...
            logging.exception(ex)
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("sendEmailMessae", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class sendEmailMessae_args(object):
    """
    Attributes:
     - email
     - message
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, (self.__class__, self.thrift_spec)))
            return
        oprot.writeStructBegin('sendEmailMessae_args')
...
class sendEmailMessae_result(object):
    """
    Attributes:
     - success
    """
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, (self.__class__, self.thrift_spec)))
            return
        oprot.writeStructBegin('sendEmailMessae_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.BOOL, 0)
            oprot.writeBool(self.success)
            oprot.writeFieldEnd()
